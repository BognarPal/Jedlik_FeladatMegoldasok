...
let AppComponent = class AppComponent {
    ...
    createHttpRequest(statusObj) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + statusObj.url).subscribe((res) => {
            if (res && res.alive) {
    ...
    reloadSqlTasks() {
        ...
        this.subscription = this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/sqltasks').subscribe(res => {
    ...
    reloadVelemenyek() {
        this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/velemeny').subscribe(res => {
            this.velemenyek = res;
        }, err => {
            console.log('err: ', err);
        });
    ...
    deleteVelemenyek() {
        this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/velemeny').subscribe(res => {
    ...
    requestSqlTaskResults() {
        this.sqlTasks.forEach(entry => {
            ...
            this.sqlTaskSubscriptions[entry.id] = this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + '/lekerdezes/' + entry.id).subscribe(res => {
                this.dbIsNotYetCreated = false;
                entry.response = res;
            }, err => {
